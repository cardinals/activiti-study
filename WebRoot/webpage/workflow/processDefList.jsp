...
<script type="text/javascript" charset="utf-8">
	...
	function exportXls() {
		 window.location.href="roadLineController.do?exportXls";
	}
	
	function importXls() {
		add('路线导入', 'roadLineController.do?goImplXls', "roadLineList");
	}
</script>
<!-- <script type="text/javascript" src="js/workflow/processDef.js" ></script> -->
